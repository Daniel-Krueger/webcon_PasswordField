var component_9e084d0e_f6cc_40f1_9c69_1519024dafc1 = (function (react) {
	'use strict';
	...
	*/
	...
	var urlConstructorDetection = !fails(function () {
	  ...
	  return !params.size && (!descriptors)
	    || !params.sort
	...
	var encodeURIComponent = global_1.encodeURIComponent;
	...
	defineBuiltIn(URLSearchParamsPrototype, ITERATOR$5, URLSearchParamsPrototype.entries, { name: 'entries' });
	...
	*/
	...
	var PasswordComponent = /*#__PURE__*/function (_PureComponent) {
	  _inherits(PasswordComponent, _PureComponent);
	  ...
	  function PasswordComponent() {
	    ...
	    _defineProperty(_assertThisInitialized(_this), "state", createState(_this.props.data));
	    _defineProperty(_assertThisInitialized(_this), "handleBlur", function () {
	      var onChange = _this.props.onChange;
	      var _this$state = _this.state,
	        inputValue = _this$state.inputValue,
	        prevData = _this$state.prevData;
	      var data = inputValue;
	      if (data !== prevData) {
	        onChange(data);
	      }
	  ...
	  _createClass(PasswordComponent, [{
	    ...
	    value: function render() {
	      ...
	      var fieldConfiguration = this.props.fieldConfiguration;
	      var isDisabled = fieldConfiguration.isDisabled;
	      var isAdmin = fieldConfiguration.isAdmin;
	      var isReadonly = isDisabled && !isAdmin;
	      return webcon.createElement("div", null, webcon.createElement("input", {
	        className: classnames('wfFormControl', 'form-control', className),
	...
	_defineProperty(PasswordComponent, "propTypes", {
	...
	var CustomControlComponent = function CustomControlComponent(_ref) {
	  var fieldConfiguration = _ref.fieldConfiguration,
	    model = _ref.model,
	    onChange = _ref.onChange,
	    sdkConfiguration = _ref.sdkConfiguration;
	  if (fieldConfiguration.editMode === 'ReadOnlyHtml' && !fieldConfiguration.isAdmin) {
	    return webcon.createElement("span", {
	      className: "form-control-readonly"
	    }, JSON.parse(model)["hint"]);
	  } else {
	    return webcon.createElement(PasswordComponent, {
	      data: model,
	      onChange: onChange,
	...
	CustomControlComponent.propTypes = {
	  fieldConfiguration: propTypes.shape({
	    ...
	    editMode: propTypes.oneOf(['Edit', 'ReadOnly', 'ReadOnlyHtml']).isRequired,
...
window.webcon.customControls.components = window.webcon.customControls.components || {};
window.webcon.customControls.components['9e084d0e-f6cc-40f1-9c69-1519024dafc1'] = component_9e084d0e_f6cc_40f1_9c69_1519024dafc1;
